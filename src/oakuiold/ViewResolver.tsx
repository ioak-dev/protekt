      ...
      <>
        {!this.state.mobileViewPort && (
          <div className="view-desktop">
            {this.state.side && (
              <div className="view-side">{this.state.side}</div>
            )}
            <div
              className={
                'view-content' + (this.state.side ? ' side-present' : '')
              }
            >
              {this.state.main}
            </div>
        ...
        {this.state.mobileViewPort && (
          <div className="view-mobile">
            <div
              className={this.state.showSide ? 'slider show' : 'slider hide'}
            >
              <div className="topbar" onClick={this.toggleSideView}>
                <div>
                  <OakButton
                    theme="default"
                    variant="disabled"
                    action={this.toggleSideView}
                  >
                    {!this.state.showSide && (
                      <>
                        <i className="material-icons">expand_more</i>
                        {this.props.sideLabel ? this.props.sideLabel : 'Menu'}
                      </>
                    )}
                    {this.state.showSide && (
                      <>
            ...
            {!this.state.showSide && (
              <div className="view-main">{this.state.main}</div>
            )}
          </div>
        )}
      </>
