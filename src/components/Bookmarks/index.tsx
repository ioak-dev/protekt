    ...
    this.setState({
      view: this.state.items.filter(item => {
        if (
          ...
          this.state.searchPref.href &&
          match(item.href, this.state.searchtext)
        ) {
          return true;
        }
      }),
        ...
        >
          ...
          <div className="dialog-footer">
            ...
            >
              ...
              {this.state.editDialogLabel}
            </OakButton>
          </div>
        </OakDialog>

        <ViewResolver>
          <View main>{listview}</View>
          <View side>
            <div className="filter-container">
              <div className="section-main">
                ...
                <Sidebar
                  ...
                  animate
                  number={
                    this.state.isFiltered ? this.state.view.length : undefined
                  }
                >
                  ...
                  {this.state.isFiltered && (
                    <div className="typography-4 space-top-2 space-left-2">
                      Found {this.state.view.length} bookmarks matching the
                      search criteria
                    </div>
                  )}
                  <div className="actionbar-2 space-top-2 space-bottom-2">
                    <div>
                      <OakButton action={this.clearSearch} theme="default">
                        Clear
                      </OakButton>
                    </div>
                    <div>
