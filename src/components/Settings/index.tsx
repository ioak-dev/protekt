...
class Settings extends React.Component<Props, State> {
  ...
  changePassword = () => {
    ...
    if (
      isEmptyOrSpaces(this.state.newPassword) ||
  ...
  fileChoosen = event => {
    ...
    reader.onload = function(event: any) {
      importBookmarks(
        ...
        sendMessage('notification', true, {
          message:
            'Imported (' + response.data.length + ') bookmarks successfully',
          type: 'success',
          duration: 6000
        });
      });
          ...
          <View main>
            ...
            <div className="appearance">
              ...
              <div className=" space-bottom-2">
                <div
                  className={
                    'text-size size-1 space-right-1 ' +
                    (this.props.profile.textSize === 'textsize_tiny'
                      ? 'active'
                      : '')
                  }
                  onClick={() => this.changeTextSize('textsize_tiny')}
                >
                  Az
                </div>
                <div
                  className={
                    'text-size size-2 space-right-1 ' +
                    (this.props.profile.textSize === 'textsize_small'
                      ? 'active'
                      : '')
                  }
                  onClick={() => this.changeTextSize('textsize_small')}
                >
                  Az
                </div>
                <div
                  className={
                    'text-size size-3 space-right-1 ' +
                    (this.props.profile.textSize === 'textsize_medium'
                      ? 'active'
                      : '')
                  }
                  onClick={() => this.changeTextSize('textsize_medium')}
                >
                  Az
                </div>
                <div
                  className={
                    'text-size size-4 ' +
                    (this.props.profile.textSize === 'textsize_large'
                      ? 'active'
                      : '')
                  }
                  onClick={() => this.changeTextSize('textsize_large')}
                >
                  Az
                </div>
              </div>
